  ...
  return (
    <div className="flex flex-col lg:flex-row  w-full h-[700px]">
      ...
      <div className=" w-full md:w-[40vw]  flex flex-col justify-center font-roboto items-start p-8 ">
        <h1 className="lg:text-8xl text-4xl sm:text-6xl md:absolute font-bold text-gray-800 tracking-wide top-20 text-center lg:top-20 lg:left-50 mb-4">Welcome to Our Store</h1>
        <div className='absolute md:static translate-y-130 sm:translate-y-150 md:translate-y-15 lg:translate-0'>
        <h2 className='text-lg lg:text-3xl -translate-y-10 font-semibold text-gray-600 mb-2'>Your One-Stop Shop for Everything You Need!</h2>
        <p className=" text-base lg:text-lg -translate-y-10 text-zinc-600 mb-1 ">Find the best products here!</p>
