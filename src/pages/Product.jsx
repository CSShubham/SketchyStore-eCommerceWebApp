  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full text-left rounded-xl border border-gray-300 bg-white px-4 py-2 shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        {selected}
      </button>
       {isOpen && (
        <div className="absolute z-1 mt-2 w-full rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5">
          <div className="py-1">
            {options.map((option) => (
              <button
                key={option.value}
